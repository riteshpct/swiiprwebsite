...
const Footer = () => {
  return (
    <footer className="bg-[#0A1421] pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-12 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#D4A84B]/20 to-[#D4A84B]/5 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <path d="M12 2L2 7l10 5 10-5-10-5z" fill="#D4A84B" opacity="0.9"/>
                  <path d="M2 17l10 5 10-5" stroke="#D4A84B" strokeWidth="2" fill="none" opacity="0.6"/>
                  <path d="M2 12l10 5 10-5" stroke="#D4A84B" strokeWidth="2" fill="none" opacity="0.8"/>
                </svg>
              </div>
              ...
              <ul className="space-y-3">
                {col.links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-sm text-white/40 hover:text-[#D4A84B] transition-colors duration-300"
                    >
                      {link}
                    </a>
                  </li>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="group">
                <div className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-white/5 border border-white/10 hover:border-[#D4A84B]/30 transition-all">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M3 20.5V3.5C3 2.91 3.34 2.39 3.84 2.15L13.69 12L3.84 21.85C3.34 21.6 3 21.09 3 20.5Z" fill="#D4A84B" opacity="0.8"/>
                    <path d="M16.81 15.12L6.05 21.34L14.54 12.85L16.81 15.12Z" fill="#D4A84B" opacity="0.6"/>
                    <path d="M21.4 10.74C21.75 10.99 22 11.39 22 12C22 12.61 21.75 13.01 21.4 13.26L18.78 14.76L16.28 12.26L18.78 9.76L21.4 10.74Z" fill="#D4A84B" opacity="0.4"/>
                  </svg>
                  <div>
              ...
              <a href="#" className="group">
                <div className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-white/5 border border-white/10 hover:border-[#D4A84B]/30 transition-all">
                  <svg width="18" height="20" viewBox="0 0 18 22" fill="#D4A84B" opacity="0.8">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a
            href="#book-demo"
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-white/15 text-white/60 text-sm font-medium hover:border-[#D4A84B]/30 hover:text-[#D4A84B] transition-all duration-300"
          >
...
const ShieldBadge = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D4A84B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
